...
import './Math.css'; // Import styles specific to the Math component
...
const Math = () => {
    ...
    const [lessons] = useState([]); // Assuming lessons will be populated dynamically
    const [videos] = useState([]); // Assuming videos will be populated dynamically
    const [books] = useState([]); // Assuming books will be populated dynamically
